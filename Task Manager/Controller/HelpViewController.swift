...
class HelpViewController: UIViewController {
    ...
    var subTitleArray: [String] = ["Check It lets you track\n your daily tasks, create grocery\n lists, and so much more!", "The first step is creating an account. Enter a valid email address and password to create an account.", "After that create categories, lists of items, check them off!, and even share them with your friends 😀"]
